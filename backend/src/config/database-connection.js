...
async function databaseInserts() {
    ...
    //     { nome: "Óleo de Motor 5W30", codigo: 1001, preco: 45.90, estoque: 50 },
    //     { nome: "Filtro de Óleo", codigo: 1002, preco: 12.50, estoque: 100 },
    //     { nome: "Filtro de Ar", codigo: 1003, preco: 18.75, estoque: 80 },
    //     { nome: "Pastilha de Freio Dianteira", codigo: 1004, preco: 89.90, estoque: 30 },
    //     { nome: "Pastilha de Freio Traseira", codigo: 1005, preco: 75.50, estoque: 25 },
    //     { nome: "Correia Dentada", codigo: 1006, preco: 120.00, estoque: 15 },
    //     { nome: "Bateria 60Ah", codigo: 1007, preco: 280.00, estoque: 20 },
    //     { nome: "Pneu 195/65R15", codigo: 1008, preco: 320.00, estoque: 40 },
    //     { nome: "Amortecedor Dianteiro", codigo: 1009, preco: 450.00, estoque: 12 },
    //     { nome: "Rolamento Roda", codigo: 1010, preco: 85.00, estoque: 35 },
    //     { nome: "Bomba de Combustível", codigo: 1011, preco: 380.00, estoque: 8 },
    //     { nome: "Bico Injetor", codigo: 1012, preco: 220.00, estoque: 18 },
    //     { nome: "Velas de Ignição", codigo: 1013, preco: 35.00, estoque: 60 },
    //     { nome: "Lâmpada Farol H4", codigo: 1014, preco: 25.00, estoque: 45 },
    //     { nome: "Fluido de Freio DOT4", codigo: 1015, preco: 15.90, estoque: 70 }
    // ]);
