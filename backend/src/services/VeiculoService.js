...
class VeiculoService {
  ...
  static async create(req) {
    const { marca, modelo, ano, numeroChassi, tipoCombustivel, placa, cliente_id } = req.body;
    ...
    if (!modelo) throw new Error("O Modelo do Veículo deve ser preenchida!");
    ...
    if (!cliente_id) throw new Error("O cliente deve ser informado!");
